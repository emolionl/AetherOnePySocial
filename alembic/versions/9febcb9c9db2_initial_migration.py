...
Revision ID: 9febcb9c9db2
Revises: 
Create Date: 2025-05-31 23:06:45.647189
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('user_id', 'key', 'local_session_id', name='_user_key_local_session_id_uc')
    )
